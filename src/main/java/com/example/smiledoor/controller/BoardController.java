package com.example.smiledoor.controller;

import com.example.smiledoor.dto.BoardDto;
import com.example.smiledoor.dto.BoardFileDto;
import com.example.smiledoor.service.BoardService;
...
public class BoardController {
    ...
    public ModelAndView writeBoard(HttpServletRequest request) throws Exception{
        ...
        BoardDto user = new BoardDto(); // 아마도 로그인 서비스 생기면 UserDto 로 변경하면됨 변수도 그걸로
